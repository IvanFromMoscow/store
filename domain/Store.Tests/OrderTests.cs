...
namespace Store.Tests
{
    public class OrderTests
    {
        ...
        [Fact]
        public void TotalPrice_WithEmptyItems_ReturnsZeroM()
        {
            var order = new Order(1, new OrderItem[0]);
        ...
        [Fact]
        public void Get_WithNotExistingItem_ThrowInvalidOperationException()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
            ...
            var notExistIndex = 4;
            Assert.Throws<InvalidOperationException>(() => order.GetItem(notExistIndex));
        }
        ...
        [Fact]
        public void AddOrUpdateItem_WithNotExistingItem_AddCount()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
        ...
        [Fact]
        public void RemoveItem_WithNotExistingItem_ThrowInvalidOperationException()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
